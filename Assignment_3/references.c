...
//     int turnaround_time;
//     int running_time;
//     int last_time;    // Track last time state changed
// } Process;
...
//         #if VERBOSE
//         printf("Process %d: Initial burst time = %d, Arrival time = %d\n",
//                processes[i].id, processes[i].bursts[0], processes[i].arrival_time);
//         #endif
//     }
...
//         #if VERBOSE
//         printf("\nTime %d: Processing event - ", event.time);
//         switch(event.type) {
//             case ARRIVAL: printf("ARRIVAL"); break;
//             case CPU_COMPLETION: printf("CPU_COMPLETION"); break;
//             case IO_COMPLETION: printf("IO_COMPLETION"); break;
//             case CPU_TIMEOUT: printf("CPU_TIMEOUT"); break;
//         }
//         printf(" for Process %d\n", processes[event.process_idx].id);
//         #endif
...
//             #if VERBOSE
//             printf("CPU was idle for %d units\n", event.time - current_time);
//             #endif
//         }
...
//             case IO_COMPLETION:
//                 #if VERBOSE
//                 printf("Process %d state: %s -> READY\n", p->id,
//                        event.type == ARRIVAL ? "NEW" : "WAITING");
//                 printf("Ready Queue: ");
//                 for (int i = 0; i < ready_queue.size; i++) {
//                     int idx = (ready_queue.front + i) % MAX_PROCESSES;
//                     printf("%d ", processes[ready_queue.items[idx]].id);
//                 }
//                 printf("\n");
//                 #endif
...
//                 } else {
//                     #if VERBOSE
//                     printf("Process %d starting IO burst of length %d\n",
//                            p->id, p->bursts[p->current_burst]);
//                     #endif
...
// void schedule_process(int quantum, int verbose) {
//     if (is_queue_empty(&ready_queue)) {
//         is_cpu_idle = 1;
//         return;
//     }
...
// void simulate(int quantum, int verbose) {
//     printf("**** %s Scheduling %s ****\n",
//            quantum == INT_MAX ? "FCFS" : "RR",
//            quantum == INT_MAX ? "" : (quantum == 10 ? "with q = 10" : "with q = 5"));
...
//                 if (is_cpu_idle) {
//                     schedule_process(quantum, verbose);
//                 }
//                 break;
...
//     // Verbose RR with quantum 10
//     simulate(10, 1);
    
//     // Concise RR with quantum 10
//     simulate(10, 0);
    
//     // Verbose RR with quantum 5
//     simulate(5, 1);
    
//     // Concise RR with quantum 5
//     simulate(5, 0);
